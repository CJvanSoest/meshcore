...
static const uint8_t GOLDEN_SIG[64] = {
    0x72,0x26,0x9c,0x4a,0xa2,0xd6,0x4d,0x72,
    0x42,0x4a,0xc4,0x72,0x63,0x3d,0xe1,0xc4,
    0xb8,0xea,0x7d,0xb3,0x78,0xd6,0x30,0x13,
    0xac,0xb1,0xe4,0x50,0x7a,0x32,0x47,0x2b,
    0xaa,0x46,0x89,0xf5,0x0b,0x27,0x96,0xf6,
    0x9d,0x2a,0x94,0xc4,0x11,0x19,0xd4,0x9c,
    0x10,0x29,0x58,0x7b,0xdd,0x3d,0x16,0xf5,
    0xba,0x8e,0xfd,0x32,0x86,0xb9,0x59,0x02
};
...
int main(void) {
    ...
    CHECK(memcmp(to_sign + head, payload + after_sig, tail) == 0,
          "signable continues past the 64-byte signature slot");
