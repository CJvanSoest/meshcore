...
typedef struct {
    ...
    uint8_t  txt_type;
    uint32_t sender_timestamp;
    uint8_t  text[MESHCORE_COMPANION_MAX_PAYLOAD_SIZE - sizeof(uint8_t) * 6 - sizeof(uint32_t)];
} __attribute__((packed)) companion_resp_channel_msg_recv_v3_args_t;
...
typedef struct {
    ...
    union {
        ...
        companion_resp_channel_msg_recv_v3_args_t response_channel_msg_recv_v3_args;
